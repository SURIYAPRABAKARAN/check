...
public class LoginController {
	...
	public String addProduct(Model model,@RequestParam String pname , @RequestParam String psize , @RequestParam String pprice)
	{
	...
	public String deleteProduct(Model model,@RequestParam String pn, @RequestParam String ps,@RequestParam String pp)
	{
		Productbean pdbObj = new Productbean();
	...
	public String updateProductJsp(Model model,@RequestParam String pn, @RequestParam String ps,@RequestParam String pp)
	{
		Productbean pdbObj = new Productbean();
		pdbObj.setProductname(pn);
		pdbObj.setProductsize(ps);
	...
	public String afterUpdateMethod(Model model,@RequestParam String pn, @RequestParam String ps,@RequestParam String pp)
	{
		Productbean pdbObj = new Productbean();
		pdbObj.setProductname(pn);
		pdbObj.setProductsize(ps);
	...
	public String buyMappingMethod(Model model,@RequestParam String pn, @RequestParam String ps,@RequestParam String pp)
	{
		Productbean pdbObj = new Productbean();
		pdbObj.setProductname(pn);
		pdbObj.setProductsize(ps);
	...
	public String userPage(Model model, @RequestParam("userId") String userId , @RequestParam("userPassword") String userPassword) throws userNotFountException
	{
